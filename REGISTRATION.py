...
firstw=Tk()
firstw.title("SHREE KANHA KRISHNA PLAY SCHOOL")
firstw.geometry("1600x1000+0+0")
label=Label(text="VAISHNAV'S  UNIVERSITY",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="SHREE KANHA KRISHNA KIDS PLAY SCHOOL", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def distroy():
    firstw.destroy()
def login():
    if user.get()=="Mayank" and user3.get()=="MAMYL@123":
        second()
        distroy()
